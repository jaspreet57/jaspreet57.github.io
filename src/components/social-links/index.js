  ...
  return (
    <React.Fragment>
        <StyledSocialList>
            ...
            <li>   
                <SocialLink target="_blank" href="https://www.linkedin.com/in/erjaspreet57" >
                    <i className="fa fa-linkedin" title="Linkedin link" />
                </SocialLink>
            </li>
            <li>   
                <SocialLink target="_blank" href="https://www.facebook.com/jaspreet.s.saran">
                    <i className="fa fa-facebook" title="Facebook link" />
                </SocialLink>
            </li>
            <li>   
                <SocialLink target="_blank" href="https://www.instagram.com/jaspreet.s.saran">
            ...
            <li>   
                <SocialLink target="_blank" href="https://www.youtube.com/channel/UCo-24ZAY9GvLVfVeKaPA5ag">
