        ...
        <Grid item md={8} xs={12}>
          ...
          <Grid container spacing={1}>
            <Grid item display="flex" alignItems="center" md={4} xs={6}>
              ...
              <Typography fontWeight="bold" fontSize="20px">Javascript</Typography>
            </Grid>
            <Grid item display="flex" alignItems="center" md={4} xs={6}>
              <ReactIcon width="50px" />
              <Typography fontWeight="bold" fontSize="20px"> React JS</Typography>
            </Grid>
            <Grid item display="flex" alignItems="center" md={4} xs={6}>
              <GoIcon width="50px" />
              <Typography fontWeight="bold" fontSize="20px">Go Lang</Typography>
            </Grid>
          </Grid>
        </Grid>
